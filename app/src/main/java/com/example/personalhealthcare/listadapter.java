...
public class listadapter extends RecyclerView.Adapter<listadapter.ViewHolder> {
	...
	public listadapter(Context context, ArrayList<appointments> appointments, String uid) {
	...
	public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View v;
		v = LayoutInflater.from(context).inflate(R.layout.aproved_appointment_list, parent, false);
						 ...
						 .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
							 ...
							 public void onClick(DialogInterface dialog, int which) {
								 ...
								 FirebaseDatabase.getInstance().getReference("User").child(FirebaseAuth.getInstance()
										  ...
										  .child("fixedappoitnments").child(uid).removeValue();
								 ...
								 findphno(uid, "The appointment has been canceled");
